...
- name: Renew id_vars_example.yaml
  ...
  - file:
      ...
      state: absent
~~~
После выполнения плейбуков будет создан файл **id_var_<имя кластера>.yaml**. Этот файл содержит идентификаторы всех ресурсов. Clouni использует этот файл для удаления соответствующих облачных ресурсов.
